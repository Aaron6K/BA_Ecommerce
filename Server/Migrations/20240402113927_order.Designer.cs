...
namespace BA_Ecommerce.Server.Migrations
{
    ...
    [Migration("20240402113927_order")]
    partial class order
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BA_Ecommerce.Shared.CartItem", b =>
                {
            ...
            modelBuilder.Entity("BA_Ecommerce.Shared.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BA_Ecommerce.Shared.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BA_Ecommerce.Shared.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("BA_Ecommerce.Shared.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BA_Ecommerce.Shared.OrderItem", b =>
                {
                    b.HasOne("BA_Ecommerce.Shared.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("BA_Ecommerce.Shared.Product", b =>
                {
                    b.HasOne("BA_Ecommerce.Shared.Category", "Category")
                        .WithMany()
